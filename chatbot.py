...
flag=True
print("HAL: My name is HAL. I will answer your queries about Chatbots. If you want to exit, type Bye!")
while(flag==True):
    user_response = input()
    ...
    if(user_response!='bye'):
        if(user_response=='thanks' or user_response=='thank you' ):
            flag=False
            print("HAL: You are welcome..")
        else:
            if(greeting(user_response)!=None):
                print("HAL: "+greeting(user_response))
            else:
                print("HAL: ",end="")
